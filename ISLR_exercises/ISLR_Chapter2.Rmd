...
Let's compare prepare the data from those two suburbs before we start:
```{r suburb_comparison_setup}
highest_and_lowest <- Boston[lstat %in% c(lowest_lstat, highest_lstat),]
highest_and_lowest[order(lstat),]
